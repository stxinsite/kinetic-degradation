"""This script plots the result of an analysis of the effect of cooperativity and binary target Kd on degradation.
"""
...
labels[4] = ""
ax.legend(handles=handles[1:], labels=labels[1:], loc='upper right', borderaxespad=0.25)
