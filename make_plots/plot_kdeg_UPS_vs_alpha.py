...
and proteasomal degradation rate on degradation.
"""
import numpy as np
import pandas as pd
...
protac_id = 'ACBI1'
t = 6
result_id = f"{protac_id}t={t}_kdeg_UPS_vs_alpha_DEG"
...
result = result[['degradation', 'all_Ternary', 'alpha', 'kdeg_UPS']]
...
labels[0] = 'Target UPS Degradation (1/h)'
