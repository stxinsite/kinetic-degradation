...
def solve_ODE(params):
    ...
    """
    VARY INITIAL BPD_ic CONCENTRATION
    """
    ...
    """
    CALCULATE TERNARY COMPLEX FORMATION RELATIVE TO MAX TERNARY COMPLEX FORMATION
    """
    ...
    """
    PLOT PERCENT RELATIVE TERNARY COMPLEX FORMATION OVER INITIAL BPD_ic CONCENTRATION
    """
